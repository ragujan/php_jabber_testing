		...
		if (isset($tpl['arr']))
		{
			...
			<table cellspacing="2" cellpadding="5" style="width: 100%">
				...
				<tbody>	
					...
					<tr>
						<td><?php __('front_cancel_event'); ?></td>
						<td><?php echo $tpl['arr']['event_title']; ?></td>
					</tr>
					<tr>
						<td><?php __('front_cancel_date_time'); ?></td>
						<td><?php echo @$tpl['arr']['date_time']; ?></td>
					</tr>
					<tr>
						<td><?php __('front_cancel_booking_seats'); ?></td>
						<td><?php echo @$tpl['arr']['seats']; ?></td>
					</tr>
					<tr>
						<td><?php __('front_cancel_tickets'); ?></td>
						<td><?php echo @$tpl['arr']['tickets']; ?></td>
					</tr>
					<tr>
