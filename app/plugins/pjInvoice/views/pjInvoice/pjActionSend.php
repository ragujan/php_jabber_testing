	...
	if (isset($tpl['arr']) && !empty($tpl['arr']))
	{
		...
		<p>
			...
			<span class="pj-form-field-custom pj-form-field-custom-before">
				...
				<input type="text" name="b_email" class="pj-form-field email w250" value="<?php echo pjSanitize::html(@$tpl['arr']['b_email']); ?>" />
			</span>
		</p>
		<?php
		if ((int) $tpl['config_arr']['si_include'] === 1 && (int) $tpl['config_arr']['si_email'] === 1)
		{
			...
			<p>
				...
				<span class="pj-form-field-custom pj-form-field-custom-before">
					<span class="pj-form-field-before"><abbr class="pj-form-field-icon-email"></abbr></span>
					<input type="text" name="s_email" class="pj-form-field email w250" value="<?php echo pjSanitize::html(@$tpl['arr']['s_email']); ?>" />
				</span>
			</p>
			<?php
		}
