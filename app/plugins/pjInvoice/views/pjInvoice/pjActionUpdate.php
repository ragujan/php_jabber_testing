				...
				<fieldset class="fieldset light">
					...
					<div class="float_right w400">
						<p>
							...
							{
							    ?><a href="<?php echo PJ_INSTALL_URL . str_replace('{ORDER_ID}', $tpl['arr']['order_id'], PJ_INVOICE_PLUGIN); ?>"><?php echo pjSanitize::html(@$tpl['arr']['order_id']); ?></a><?php
							} else {
							    echo pjSanitize::html(@$tpl['arr']['order_id']);
							}
							?></span>
						</p>
						<p>
				...
				<fieldset class="fieldset sky">
					...
					<div class="float_left w350">
						<p>
							...
							<span class="pj-form-field-custom pj-form-field-custom-before">
								...
								<input type="text" name="subtotal" id="subtotal" class="pj-form-field number w80" value="<?php echo pjSanitize::html(@$tpl['arr']['subtotal']); ?>" />
							</span>
						</p>
						<p>
							...
							<span class="pj-form-field-custom pj-form-field-custom-before">
								<span class="pj-form-field-before"><abbr class="pj-form-field-icon-text"><?php echo pjUtil::formatCurrencySign(NULL, $tpl['arr']['currency'], ""); ?></abbr></span>
								<input type="text" name="discount" id="discount" class="pj-form-field number w80" value="<?php echo pjSanitize::html(@$tpl['arr']['discount']); ?>" />
							</span>
						</p>
						<p>
							...
							<span class="pj-form-field-custom pj-form-field-custom-before">
								<span class="pj-form-field-before"><abbr class="pj-form-field-icon-text"><?php echo pjUtil::formatCurrencySign(NULL, $tpl['arr']['currency'], ""); ?></abbr></span>
								<input type="text" name="tax" id="tax" class="pj-form-field number w80" value="<?php echo pjSanitize::html(@$tpl['arr']['tax']); ?>" />
							</span>
						</p>
						...
						<p>
							...
							<span class="pj-form-field-custom pj-form-field-custom-before">
								<span class="pj-form-field-before"><abbr class="pj-form-field-icon-text"><?php echo pjUtil::formatCurrencySign(NULL, $tpl['arr']['currency'], ""); ?></abbr></span>
								<input type="text" name="shipping" id="shipping" class="pj-form-field number w80" value="<?php echo pjSanitize::html(@$tpl['arr']['shipping']); ?>" />
							</span>
						</p>
						<?php endif; ?>
						<p>
							...
							<span class="pj-form-field-custom pj-form-field-custom-before">
								<span class="pj-form-field-before"><abbr class="pj-form-field-icon-text"><?php echo pjUtil::formatCurrencySign(NULL, $tpl['arr']['currency'], ""); ?></abbr></span>
								<input type="text" name="total" id="total" class="pj-form-field number w80" value="<?php echo pjSanitize::html(@$tpl['arr']['total']); ?>" />
							</span>
						</p>
						<p>
							...
							<span class="pj-form-field-custom pj-form-field-custom-before">
								<span class="pj-form-field-before"><abbr class="pj-form-field-icon-text"><?php echo pjUtil::formatCurrencySign(NULL, $tpl['arr']['currency'], ""); ?></abbr></span>
								<input type="text" name="paid_deposit" id="paid_deposit" class="pj-form-field number w80" value="<?php echo pjSanitize::html(@$tpl['arr']['paid_deposit']); ?>" />
							</span>
						</p>
						<p>
							...
							<span class="pj-form-field-custom pj-form-field-custom-before">
								<span class="pj-form-field-before"><abbr class="pj-form-field-icon-text"><?php echo pjUtil::formatCurrencySign(NULL, $tpl['arr']['currency'], ""); ?></abbr></span>
								<input type="text" name="amount_due" id="amount_due" class="pj-form-field number w80" value="<?php echo pjSanitize::html(@$tpl['arr']['amount_due']); ?>" />
							</span>
						</p>
						<p>
					...
					<div class="float_right w350">
						...
						<p>
							...
							<span class="left">
								<textarea name="notes" id="notes" class="pj-form-field" style="width: 325px; height: 236px"><?php echo pjSanitize::html(@$tpl['arr']['notes']); ?></textarea>
							</span>
						</p>
					</div>
					<br class="clear_both" />
			...
			<div id="tabs-2">
				...
				<fieldset class="fieldset white">
					...
					<p>
						...
						<span class="left">
							<input type="text" name="b_billing_address" id="b_billing_address" class="pj-form-field w500" value="<?php echo pjSanitize::html(@$tpl['arr']['b_billing_address']); ?>" />
						</span>
					</p>
					<p>
					...
					<p>
						...
						<span class="left">
							<input type="text" name="b_name" id="b_name" class="pj-form-field w500" value="<?php echo pjSanitize::html(@$tpl['arr']['b_name']); ?>" />
						</span>
					</p>
					<p>
						<label class="title"><?php __('plugin_invoice_i_address'); ?></label>
						<span class="left">
							<input type="text" name="b_address" id="b_address" class="pj-form-field w500" value="<?php echo pjSanitize::html(@$tpl['arr']['b_address']); ?>" />
						</span>
					</p>
					<p>
						<label class="title"><?php __('plugin_invoice_i_street_address'); ?></label>
						<span class="left">
							<input type="text" name="b_street_address" id="b_street_address" class="pj-form-field w500" value="<?php echo pjSanitize::html(@$tpl['arr']['b_street_address']); ?>" />
						</span>
					</p>
					<p>
					...
					<p>
						...
						<span class="left">
							<input type="text" name="b_city" id="b_city" class="pj-form-field w500" value="<?php echo pjSanitize::html(@$tpl['arr']['b_city']); ?>" />
						</span>
					</p>
					<p>
						<label class="title"><?php __('plugin_invoice_i_state'); ?></label>
						<span class="left">
							<input type="text" name="b_state" id="b_state" class="pj-form-field w500" value="<?php echo pjSanitize::html(@$tpl['arr']['b_state']); ?>" />
						</span>
					</p>
					<p>
						<label class="title"><?php __('plugin_invoice_i_zip'); ?></label>
						<span class="left">
							<input type="text" name="b_zip" id="b_zip" class="pj-form-field w500" value="<?php echo pjSanitize::html(@$tpl['arr']['b_zip']); ?>" />
						</span>
					</p>
					<p>
						...
						<span class="pj-form-field-custom pj-form-field-custom-before">
							...
							<input type="text" name="b_phone" id="b_phone" class="pj-form-field" style="width: 473px" value="<?php echo pjSanitize::html(@$tpl['arr']['b_phone']); ?>" />
						</span>
					</p>
					<p>
						...
						<span class="pj-form-field-custom pj-form-field-custom-before">
							<span class="pj-form-field-before"><abbr class="pj-form-field-icon-phone"></abbr></span>
							<input type="text" name="b_fax" id="b_fax" class="pj-form-field" style="width: 473px" value="<?php echo pjSanitize::html(@$tpl['arr']['b_fax']); ?>" />
						</span>
					</p>
					<p>
						...
						<span class="pj-form-field-custom pj-form-field-custom-before">
							...
							<input type="text" name="b_email" id="b_email" class="pj-form-field email" style="width: 473px" value="<?php echo pjSanitize::html(@$tpl['arr']['b_email']); ?>" />
						</span>
					</p>
					<p>
						...
						<span class="pj-form-field-custom pj-form-field-custom-before">
							...
							<input type="text" name="b_url" id="b_url" class="pj-form-field" style="width: 473px" value="<?php echo pjSanitize::html(@$tpl['arr']['b_url']); ?>" />
						</span>
					</p>
					<p>
						<label class="title">&nbsp;</label>
				...
				if ((int) $tpl['config_arr']['si_include'] === 1)
				{
					...
					<fieldset class="fieldset white">
						...
						<p>
							...
							<span class="left">
								<textarea name="s_terms" id="s_terms" class="pj-form-field" style="width: 500px; height: 220px"><?php echo pjSanitize::html(@$tpl['arr']['s_terms']); ?></textarea>
							</span>
						</p>
						<p>
							<label class="title"><?php __('plugin_invoice_i_shipping_address'); ?></label>
							<span class="left">
								<input type="text" name="s_shipping_address" id="s_shipping_address" class="pj-form-field w500" value="<?php echo pjSanitize::html(@$tpl['arr']['s_shipping_address']); ?>" />
							</span>
						</p>
						<p>
							<label class="title"><?php __('plugin_invoice_i_company'); ?></label>
							<span class="left">
								<input type="text" name="s_company" id="s_company" class="pj-form-field w500" value="<?php echo pjSanitize::html(@$tpl['arr']['s_company']); ?>" />
							</span>
						</p>
						<p>
							<label class="title"><?php __('plugin_invoice_i_name'); ?></label>
							<span class="left">
								<input type="text" name="s_name" id="s_name" class="pj-form-field w500" value="<?php echo pjSanitize::html(@$tpl['arr']['s_name']); ?>" />
							</span>
						</p>
						<p>
							<label class="title"><?php __('plugin_invoice_i_address'); ?></label>
							<span class="left">
								<input type="text" name="s_address" id="s_address" class="pj-form-field w500" value="<?php echo pjSanitize::html(@$tpl['arr']['s_address']); ?>" />
							</span>
						</p>
						<p>
							<label class="title"><?php __('plugin_invoice_i_street_address'); ?></label>
							<span class="left">
								<input type="text" name="s_street_address" id="s_street_address" class="pj-form-field w500" value="<?php echo pjSanitize::html(@$tpl['arr']['s_street_address']); ?>" />
							</span>
						</p>
						<p>
							<label class="title"><?php __('plugin_invoice_i_country'); ?></label>
						...
						<p>
							<label class="title"><?php __('plugin_invoice_i_city'); ?></label>
							<span class="left">
								<input type="text" name="s_city" id="s_city" class="pj-form-field w500" value="<?php echo pjSanitize::html(@$tpl['arr']['s_city']); ?>" />
							</span>
						</p>
						<p>
							<label class="title"><?php __('plugin_invoice_i_state'); ?></label>
							<span class="left">
								<input type="text" name="s_state" id="s_state" class="pj-form-field w500" value="<?php echo pjSanitize::html(@$tpl['arr']['s_state']); ?>" />
							</span>
						</p>
						<p>
							<label class="title"><?php __('plugin_invoice_i_zip'); ?></label>
							<span class="left">
								<input type="text" name="s_zip" id="s_zip" class="pj-form-field w500" value="<?php echo pjSanitize::html(@$tpl['arr']['s_zip']); ?>" />
							</span>
						</p>
						<p>
							<label class="title"><?php __('plugin_invoice_i_phone'); ?></label>
							<span class="pj-form-field-custom pj-form-field-custom-before">
								<span class="pj-form-field-before"><abbr class="pj-form-field-icon-phone"></abbr></span>
								<input type="text" name="s_phone" id="s_phone" class="pj-form-field" style="width: 473px;" value="<?php echo pjSanitize::html(@$tpl['arr']['s_phone']); ?>" />
							</span>
						</p>
						<p>
							<label class="title"><?php __('plugin_invoice_i_fax'); ?></label>
							<span class="pj-form-field-custom pj-form-field-custom-before">
								<span class="pj-form-field-before"><abbr class="pj-form-field-icon-phone"></abbr></span>
								<input type="text" name="s_fax" id="s_fax" class="pj-form-field" style="width: 473px;" value="<?php echo pjSanitize::html(@$tpl['arr']['s_fax']); ?>" />
							</span>
						</p>
						<p>
							<label class="title"><?php __('plugin_invoice_i_email'); ?></label>
							<span class="pj-form-field-custom pj-form-field-custom-before">
								<span class="pj-form-field-before"><abbr class="pj-form-field-icon-email"></abbr></span>
								<input type="text" name="s_email" id="s_email" class="pj-form-field email" style="width: 473px;" value="<?php echo pjSanitize::html(@$tpl['arr']['s_email']); ?>" />
							</span>
						</p>
						<p>
							<label class="title"><?php __('plugin_invoice_i_url'); ?></label>
							<span class="pj-form-field-custom pj-form-field-custom-before">
								<span class="pj-form-field-before"><abbr class="pj-form-field-icon-url"></abbr></span>
								<input type="text" name="s_url" id="s_url" class="pj-form-field" style="width: 473px;" value="<?php echo pjSanitize::html(@$tpl['arr']['s_url']); ?>" />
							</span>
						</p>
						<p>
							<label class="title">&nbsp;</label>
						...
						<p>
							...
							<span class="inline_block">
								<select name="cc_type" class="pj-form-field w150">
									...
									{
										?><option value="<?php echo $k?>"<?php echo $tpl['arr']['payment_method'] == 'creditcard' && $tpl['arr']['cc_type'] == $k ? ' selected="selected"' : null;?>><?php echo $v;?></option><?php
									} 
									?>
								</select>
							</span>
